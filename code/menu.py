...
from code.const import WIN_WIDTH, COLOR_ORANGE, MENU_OPTION, COLOR_ROYAL_BLUE, COLOR_YELLOW
        ...
        while True:
            ...
            for i in range(len(MENU_OPTION)):
                if i == menu_option:
                    ...
                    self.menu_text(20, MENU_OPTION[i], COLOR_ROYAL_BLUE, ((WIN_WIDTH / 2), 200 + 25 * i))
            pygame.display.flip()
